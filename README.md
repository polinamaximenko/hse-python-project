...
#### Асимметричный поиск (оптимизирована по RAG)
...
Работает с русским и английским, включая англицизмы и терминологию.

#### Гибкость через промпты
Адаптируется под разные задачи (поиск, классификация, кластеризация) через именованные промпты.
